    ...
    <>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 space-y-6">
        ...
        <p className="text-lg text-gray-700 max-w-xl text-center">
          This is the About page for the SoloForge project. Here we demonstrate routing, reusable
          components, and project structure using Next.js, TypeScript, and Tailwind CSS.
        </p>
